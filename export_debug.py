...
def parse_opt():
    ...
    opt.weights = 'runs/train/yolov9-m2/weights/best.pt'
    # opt.out_name = 'runs/train/yolov9-m2/weights/yolov9-m-2-FP16.onnx'
    opt.imgsz = [640, 640]
    opt.batch_size = 1
    # opt.grid = True
    # 下面的参数 end2end include_nms simplify dynamic_batch 不要用True
    # opt.end2end = True
    # opt.include_nms = True
    # opt.simplify = True
    # opt.dynamic_batch = True
    opt.topk_all = 100
    opt.iou_thres = 0.45
    opt.conf_thres = 0.25
    # opt.max_wh = 640
